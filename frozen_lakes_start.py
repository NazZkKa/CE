...
if __name__ == '__main__':
    ...
    file = open(f'./results/map_{math.sqrt(config["genotype_size"])}_pcross_{config["prob_crossover"]}_pmut_{config["prob_mutation"]}_elite_{config["elite_size"]}_cross_one_point_mut_square_flip.csv', 'w')
